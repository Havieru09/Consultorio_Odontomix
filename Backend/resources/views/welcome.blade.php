...
<body class="antialiased">
    ...
    <p class="text-center text-2xl font-semibold">Confirmamos que su cita al odontologo para el paciente {{$msg['nombre_paciente']}} {{$msg['apellidos_paciente']}} para el día {{$msg['dia2']}}, {{$msg['dia']}} {{$msg['mes']}} {{$msg['anio']}}</p>
