...
Route::get('clientes2', [ClientesController::class, 'todo']);
...
Route::get('pacientes2', [PacientesController::class, 'todo']);
...
Route::get('historial_medico_paciente/{identificacion_paciente}', [Historial_ClinicoController::class, 'showPaciente']);
